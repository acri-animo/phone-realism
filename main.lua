...
function RetrieveComponents()
	Fetch = exports["reject-base"]:FetchComponent("Fetch")
	Database = exports["reject-base"]:FetchComponent("Database")
	Callbacks = exports["reject-base"]:FetchComponent("Callbacks")
	Logger = exports["reject-base"]:FetchComponent("Logger")
	Utils = exports["reject-base"]:FetchComponent("Utils")
	Chat = exports["reject-base"]:FetchComponent("Chat")
	Phone = exports["reject-base"]:FetchComponent("Phone")
	Photos = exports["reject-base"]:FetchComponent("Photos")
	Middleware = exports["reject-base"]:FetchComponent("Middleware")
	Execute = exports["reject-base"]:FetchComponent("Execute")
	Config = exports["reject-base"]:FetchComponent("Config")
	MDT = exports["reject-base"]:FetchComponent("MDT")
	Jobs = exports["reject-base"]:FetchComponent("Jobs")
	Labor = exports["reject-base"]:FetchComponent("Labor")
	Crypto = exports["reject-base"]:FetchComponent("Crypto")
	VOIP = exports["reject-base"]:FetchComponent("VOIP")
	Generator = exports["reject-base"]:FetchComponent("Generator")
	Properties = exports["reject-base"]:FetchComponent("Properties")
	Vehicles = exports["reject-base"]:FetchComponent("Vehicles")
	Inventory = exports["reject-base"]:FetchComponent("Inventory")
	Loot = exports["reject-base"]:FetchComponent("Loot")
	Loans = exports["reject-base"]:FetchComponent("Loans")
	Billing = exports["reject-base"]:FetchComponent("Billing")
	Banking = exports["reject-base"]:FetchComponent("Banking")
	Reputation = exports["reject-base"]:FetchComponent("Reputation")
	Robbery = exports["reject-base"]:FetchComponent("Robbery")
	Wallet = exports["reject-base"]:FetchComponent("Wallet")
	Sequence = exports["reject-base"]:FetchComponent("Sequence")
	Vendor = exports["reject-base"]:FetchComponent("Vendor")
	RegisterChatCommands()
end

AddEventHandler("Core:Shared:Ready", function()
	exports["reject-base"]:RequestDependencies("Phone", {
		"Fetch",
		"Database",
		"Callbacks",
		"Logger",
	...
	Callbacks:RegisterServerCallback("Phone:UpdateProfile", function(src, data, cb)
		...
		if char ~= nil then
			...
			if profiles[data.app] ~= nil then
				MySQL.insert("INSERT INTO app_profile_history (sid, app, name, picture, meta, bio) VALUES(?, ?, ?, ?, ?, ?)", {
					char:GetData("SID"),
					data.app,
					profiles[data.app].name,
					profiles[data.app].picture,
					json.encode(profiles[data.app].meta),
					profiles[data.app].bio,
				})
			end
			...
			if count == 0 then
				MySQL.prepare.await(
					"INSERT INTO character_app_profiles (sid, app, name, picture, meta, bio) VALUES(?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE name = VALUES(name), picture = VALUES(picture), meta = VALUES(meta), bio = VALUES(bio)",
					{
						char:GetData("SID"),
						data.app,
						data.name,
